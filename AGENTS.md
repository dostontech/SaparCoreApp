# SAPAR — Engineering & Agent Workflow Guide
...
- [x] Visual Sales Pipeline (Leads → Opportunities → Deals Stages Kanban)
- [x] Deal stage tracking & win/loss analytics

### 2. HRM & Payroll
- [x] Basic employee directory & user roles
- [x] Salary structure & payment recording
- [x] Uzbekistan automated payroll calculation (JShODS 12%, Ijtimoiy soliq 12%, INPS 0.1%)
- [x] Employee attendance & work hours tracking (Tabel)
- [x] Vacation, sick leave & time-off management
- [x] Hiring & onboarding pipeline
...
### 7. POS (Point of Sale)
- [x] Dedicated cashier / retail POS touch interface
- [x] Fast barcode scanning & product search
- [x] Split payment methods (Cash + Uzcard/Humo + Credit)
- [x] Fiscal receipt generation & offline resilience
- [x] Cashier shifts & end-of-day X/Z reports

### 8. Project Management
- [x] Time tracking & billable hours
- [x] Project workspace with Task Boards (Kanban / List)
- [x] Task assignments, deadlines, and milestone tracking
- [x] Project procurement & expense budget tracking
- [x] Client project profitability reporting

### 9. Customer Support
- [x] WhatsApp & Email notification triggers
- [x] Activity logs & audit trails
- [x] Helpdesk ticketing system (New, In Progress, Resolved)
- [x] Customer conversation history linked directly to orders
...
- [x] **Uzbekistan Payment & Banking Integrations**:
  - Payment Gateways: Payme Business, Click Merchant, Uzum Pay.
  - Direct Bank Statement API: 1C:ClientBank parser for Ipak Yoʻli Bank, Anorbank, Kapitalbank, Agrobank, Hamkorbank.
