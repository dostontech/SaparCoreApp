...
import HrmDashboard from "@pages/admin/dashboard/HrmDashboard";
import InventoryDashboard from "@pages/admin/dashboard/InventoryDashboard";
import CrmDashboard from "@pages/admin/dashboard/CrmDashboard";
import PosDashboard from "@pages/admin/dashboard/PosDashboard";
import FinanceDashboard from "@pages/admin/dashboard/FinanceDashboard";
import ProcurementDashboard from "@pages/admin/dashboard/ProcurementDashboard";
import ProjectsDashboard from "@pages/admin/dashboard/ProjectsDashboard";
import SupportDashboard from "@pages/admin/dashboard/SupportDashboard";
import TranslationStudio from "@pages/admin/settings/TranslationStudio";
...
import EHujjatlarDashboard from "@pages/admin/e-documents/EHujjatlarDashboard";
import EDocumentViewer from "@pages/admin/e-documents/EDocumentViewer";
...
import EdiSettings from "@pages/admin/settings/EdiSettings";
import MessagingSettings from "@pages/admin/settings/MessagingSettings";
import TelegramNotificationSettings from "@pages/admin/settings/TelegramNotificationSettings";
...
import ContrasList from "@pages/admin/accounting/ContrasList";
import CreateContra from "@pages/admin/accounting/CreateContra";
import AllReportsHub from "@pages/admin/accounting/AllReportsHub";
...
import SoliqQqsReport from "@pages/admin/accounting/reports/SoliqQqsReport";
import SoliqJshodsReport from "@pages/admin/accounting/reports/SoliqJshodsReport";
import SoliqAylanmaReport from "@pages/admin/accounting/reports/SoliqAylanmaReport";
...
import SaasClientsPage from "@pages/admin/saas/SaasClientsPage";
...
import ProjectWorkspacePage from "@pages/admin/projects/ProjectWorkspacePage";
        ...
        <Routes>
            ...
            <Route element={<AdminLayout />}>
                ...
                <Route element={<ProtectedRoute moduleSlug="dashboard" action="view" />}>
                    ...
                    <Route path="/dashboard/pos" element={<><Seo title="POS & Kassa" /><PosDashboard /></>} />
                    <Route path="/dashboard/finance" element={<><Seo title="Moliya & Buxgalteriya" /><FinanceDashboard /></>} />
                    <Route path="/dashboard/sales" element={<><Seo title="Savdo & Tushum" /><SalesDashboard /></>} />
                    <Route path="/dashboard/procurement" element={<><Seo title="Xaridlar & Taʼminot" /><ProcurementDashboard /></>} />
                    <Route path="/dashboard/projects" element={<><Seo title="Loyihalar & Vazifalar" /><ProjectsDashboard /></>} />
                    <Route path="/dashboard/support" element={<><Seo title="Mijozlar Yordami" /><SupportDashboard /></>} />
                ...
                <Route element={<ProtectedRoute moduleSlug="invoices" action="view" />}>
                    ...
                    <Route path="/e-documents" element={<><Seo title="E-Hujjatlar" /><EHujjatlarDashboard /></>} />
                    <Route path="/e-documents/view/:id" element={<><Seo title="Elektron Hujjat" /><EDocumentViewer /></>} />
                ...
                <Route element={<ProtectedRoute moduleSlug="contacts" action="view" />}>
                    <Route path="/crm/pipeline" element={<><Seo title="CRM Bitimlar Quvuri" /><CrmPipelinePage /></>} />
                    <Route path="/helpdesk/tickets" element={<><Seo title="Mijozlar Yordam Markazi" /><HelpdeskTicketsPage /></>} />
                ...
                <Route element={<ProtectedRoute moduleSlug="general-settings" action="view" />}>
                    ...
                    <Route path="/settings/uz-gateways" element={<><Seo title="Oʻzbekiston Toʻlov Tizimlari" /><UzbekPaymentGatewaysPage /></>} />
                </Route>
                ...
                <Route element={<ProtectedRoute moduleSlug="finance-settings" action="view" />}>
                    ...
                    <Route path="/settings/translations" element={<><Seo title="Tarjimalar Studiyasi" /><TranslationStudio /></>} />
                </Route>
                ...
                <Route element={<ProtectedRoute />}>
                    ...
                    <Route path="/payroll/tabel" element={<><Seo title="Ish Vaqti Hisobi (Tabel)" /><TabelAttendancePage /></>} />
                </Route>
                ...
                <Route element={<ProtectedRoute moduleSlug="journal-entries" action="view" />}>
                    ...
                    <Route path="/accounting/contras" element={<><Seo title="Contras (Vzaimozachet)" /><ContrasList /></>} />
                    <Route path="/accounting/contras/new" element={<><Seo title="New Contra" /><CreateContra /></>} />
                </Route>
                ...
                <Route element={<ProtectedRoute moduleSlug="accounting" action="view" />}>
                    ...
                    <Route path="/accounting/reports/trial-balance" element={<><Seo title="Aylanma Vedomost" /><TrialBalanceReport /></>} />

                    {/* Tax Reports (slice F.3 & Uzbekistan Soliq Declarations) */}
                    ...
                    <Route path="/accounting/projects/workspace" element={<><Seo title="Project Workspace" /><ProjectWorkspacePage /></>} />
                    <Route path="/accounting/projects/:projectId/workspace" element={<><Seo title="Project Workspace" /><ProjectWorkspacePage /></>} />
                ...
                <Route path="/settings/edi-settings" element={<><Seo title="E-Faktura & E-IMZO" /><EdiSettings /></>} />
                <Route path="/settings/messaging" element={<><Seo title="Messaging" /><MessagingSettings /></>} />
                <Route path="/settings/telegram" element={<><Seo title="Telegram Boshqaruv Boti" /><TelegramNotificationSettings /></>} />
