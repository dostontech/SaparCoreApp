...
const Seo: React.FC<SeoProps> = ({ title, description, keywords }) => {
    ...
    const defaultCompanyName = systemSettings?.company?.companyName || "Sapar";
    const defaultTitle = `${defaultCompanyName} | Business Management`;
    const defaultDescription =
        "Sapar helps you manage inventory, invoices, and products efficiently.";
    const defaultKeywords = "sapar, inventory, invoices, billing, products";
