        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="flex items-center gap-2 p-1.5 rounded-xl hover:bg-slate-100 transition focus:outline-none cursor-pointer"
              >
                <div
                  className={
                    user?.profileImageUrl
                      ? 'w-8 h-8 rounded-full ring-2 ring-teal-600 ring-offset-1 flex items-center justify-center text-xs font-semibold'
                      : 'w-8 h-8 bg-gradient-to-br from-[#028090] to-[#02C39A] text-white rounded-full flex items-center justify-center text-xs font-bold shadow-2xs'
                  }
                >
                  {user?.profileImageUrl ? (
                    <img
            ...
            <DropdownMenuContent align="end" className="w-64 p-1.5 shadow-xl border border-slate-200/80 rounded-xl">
              ...
              {/* Role Mode Context Card moved from Sidebar */}
              <div className="px-2 py-1 mb-1">
                {userRole === 'BUXGALTER' && (
                  <div className="px-2.5 py-2 rounded-lg bg-teal-50 border border-teal-200/80 flex items-center justify-between shadow-2xs">
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="text-base">👩‍💼</span>
                      <div className="min-w-0">
                        <div className="text-[11px] font-bold text-teal-900 truncate">Bosh Buxgalter</div>
                        <div className="text-[10px] text-teal-700 truncate">Buxgalteriya & Soliq Rejimi</div>
                      </div>
                    </div>
                    <span className="text-[9px] px-1.5 py-0.5 rounded bg-teal-200/60 text-teal-900 font-mono font-bold shrink-0">
                      BHMS
                    </span>
                  </div>
                )}
                {userRole === 'OMBOR_STROY' && (
                  <div className="px-2.5 py-2 rounded-lg bg-cyan-50 border border-cyan-200/80 flex items-center justify-between shadow-2xs">
                    <div className="flex items-center gap-2 min-w-0">
                    ...
                    <span className="text-[9px] px-1.5 py-0.5 rounded bg-cyan-200/60 text-cyan-900 font-mono font-bold shrink-0">
                      STOCK
                    </span>
                  </div>
                )}
                {userRole === 'ADMIN' && (
                  <div className="px-2.5 py-2 rounded-lg bg-[#F0FBF8] border border-[#02C39A]/40 flex items-center justify-between shadow-2xs">
                    <div className="flex items-center gap-2 min-w-0">
                      <span className="text-base">🏢</span>
                      <div className="min-w-0">
                    ...
                    <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#02C39A]/20 text-[#028090] font-mono font-bold shrink-0">
                      ALL
                    </span>
                  </div>
                )}
              ...
              <DropdownMenuItem asChild>
                <Link
                  ...
                  className="flex items-center gap-2 px-3 py-2 text-xs font-medium text-gray-700 hover:text-gray-900 rounded-lg"
                >
              ...
              <DropdownMenuItem
                ...
                className="flex items-center gap-2 px-3 py-2 text-xs font-medium cursor-pointer rounded-lg text-rose-600 hover:bg-rose-50"
              >
