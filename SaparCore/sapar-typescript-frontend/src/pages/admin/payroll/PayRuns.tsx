...
import { PayslipViewerModal } from '@components/admin/payroll/PayslipViewerModal';
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
                ...
                <div className="flex flex-wrap items-end gap-3">
                    ...
                    <Button
                        ...
                        leftIcon={<Calendar size={14} className="text-teal-700" />}
                        className="text-slate-800"
                    >
                        Ish Vaqti Hisobi (Tabel)
                    </Button>
                    <Button
                        variant="outline"
                        onClick={() => setIsCalcOpen(true)}
                        leftIcon={<Calculator size={14} className="text-teal-700" />}
                        className="text-slate-800"
                    >
                        Oylik & Soliqlar Kalkulyatori
                    </Button>
                </div>
            </div>
                        ...
                        <table className="w-full text-sm border-collapse">
                            <thead className="bg-gray-100 text-xs uppercase text-body">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-center border-b border-border">Raschyotniy Listok</th>
                                            ...
                                            <tr className="border-b border-border hover:bg-gray-50">
                                                ...
                                                <td className="px-4 py-3 text-center">
                                                    <Button
                                                        ...
                                                        variant="ghost"
                                                        size="sm"
                                                        onClick={() => setPayslipLineId(selectedRun?.lines[idx]?.id || 'mock-id')}
                                                        className="text-teal-700 hover:text-teal-800 flex items-center justify-center gap-1 mx-auto"
                                                    >
