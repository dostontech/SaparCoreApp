...
const HELP_TEXT =
  'Sapar ships with optional AI features. Bring your own Anthropic Claude or OpenAI key — billing goes to your account, no markup. Typical costs: ~$0.003 per bill scan, ~$0.005 per chat reply. The Mock provider returns canned data for demos without any external calls.';
