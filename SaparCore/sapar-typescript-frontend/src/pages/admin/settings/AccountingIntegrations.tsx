...
export default function AccountingIntegrations() {
  ...
  return (
    <div className="p-6 max-w-4xl">
      ...
      <p className="text-sm text-body mb-6">Connect Sapar to Xero or QuickBooks for two-way invoice sync. Provider implementations are stubbed — real OAuth requires registering an app with the provider.</p>
