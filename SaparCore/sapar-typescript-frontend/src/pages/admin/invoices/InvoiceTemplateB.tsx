...
const InvoiceTemplateB: React.FC<InvoiceDetailsProps> = ({ invoiceData, lineFields }) => {
    ...
    return (
        <InvoiceWrapper className="bg-white pl-12 pr-12 font-sans text-gray-950 max-w-5xl mx-auto my-4">
            ...
            <footer className="mt-2 pt-2 flex justify-between border-t border-gray-200">
                ...
                {(() => {
                    // merchantUpiId/merchantName live on systemSettings.company, not
                    // invoiceData.company — the invoice GET response never includes a
                    // nested company object, so reading it from invoiceData silently
                    // made this QR never render.
