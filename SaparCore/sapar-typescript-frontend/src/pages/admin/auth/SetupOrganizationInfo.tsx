                    ...
                    <div className="col-span-full pt-4 border-t border-gray-200">
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                            <p className="text-sm text-gray-600 text-center sm:text-left">
                                <strong>Note:</strong> Barcha ma'lumotlarni keyinroq Sozlamalarda oʻzgartirishingiz mumkin.
                            </p>
                            <div className="flex items-center gap-3 w-full sm:w-auto">
                                <button
                                    ...
                                    onClick={() => {
                                        ...
                                        sessionStorage.setItem("setupStatus", JSON.stringify({ new_register: false, company_settings: false }));
                                        navigate('/admin');
                                    }}
                                    className="px-5 py-3 border border-gray-300 hover:bg-gray-100 text-gray-700 font-medium text-sm rounded-lg transition-all duration-200"
                                >
                                    Keyinroq sozlash (Skip)
                                </button>
                                <button
                                    type="submit"
                                    disabled={isSaving}
                                    className={`flex items-center justify-center gap-2 px-6 bg-teal-700 hover:bg-teal-800 text-white font-medium text-sm py-3 rounded-lg transition-all duration-200 shadow-sm ${isSaving ? "opacity-60 cursor-not-allowed" : ""
                                        }`}
                                >
                                    {isSaving ? (
                                        <>
