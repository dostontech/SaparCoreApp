...
export const UzbekistanFinancialReportsPage: React.FC = () => {
  ...
  const [oborotkaData, setOborotkaData] = useState<any>(null);
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <table className="w-full text-xs">
                    <tbody className="divide-y divide-slate-100">
                      {form1Data.assets.longTerm.map((item: any) => (
                ...
                <div className="pt-2">
                  ...
                  <table className="w-full text-xs">
                    <tbody className="divide-y divide-slate-100">
                      {form1Data.assets.current.map((item: any) => (
                        <tr key={item.code} className="hover:bg-slate-50">
                          <td className="py-2 text-slate-700">{item.name}</td>
                          <td className="py-2 text-right font-mono font-bold text-slate-900">
                            {format(item.amount)}
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
              ...
              <div className="p-4 space-y-4">
                ...
                <div>
                  ...
                  <table className="w-full text-xs">
                    <tbody className="divide-y divide-slate-100">
                      {form1Data.passives.equity.map((item: any) => (
                        <tr key={item.code} className="hover:bg-slate-50">
                          <td className="py-2 text-slate-700">{item.name}</td>
                          <td className="py-2 text-right font-mono font-bold text-slate-900">
                            {format(item.amount)}
                ...
                <div className="pt-2">
                  ...
                  <table className="w-full text-xs">
                    <tbody className="divide-y divide-slate-100">
                      {form1Data.passives.liabilities.map((item: any) => (
                        <tr key={item.code} className="hover:bg-slate-50">
                          <td className="py-2 text-slate-700">{item.name}</td>
                          <td className="py-2 text-right font-mono font-bold text-slate-900">
                            {format(item.amount)}
