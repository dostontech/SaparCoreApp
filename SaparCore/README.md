...
Docker Compose stack for Sapar Core (whitelabel single-tenant invoicing).
...
The two app repos `../sapar-typescript-backend/` and `../sapar-typescript-frontend/` are independent git repos. Compose builds them from relative paths.
