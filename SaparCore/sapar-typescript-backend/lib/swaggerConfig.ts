...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.1.0',
      description: [
        'Sapar invoicing + accounting platform admin API.',
        '',
      ...
      contact: { name: 'Sapar Support', email: 'support@example.com' },
    },
    servers: [
      { url: '/api', description: 'Current host' },
      { url: 'https://sapar.dreamsmarketplace.com/api', description: 'Production' },
    ],
    components: {
      securitySchemes: {
