...
router.get('/tabel/attendance', protect, tabelController.getTabelMatrix);
router.get('/tabel/matrix', protect, tabelController.getTabelMatrix);
router.post('/tabel/matrix', protect, tabelController.saveTabelMatrix);
router.post('/tabel/save', protect, tabelController.saveTabelMatrix);

// Route aliases for frontend and API consistency
router.get('/crm/deals/pipeline', protect, crmDealsController.getDealsPipeline);
router.get('/crm/deals', protect, crmDealsController.getDealsPipeline);
router.get('/crm-deals/pipeline', protect, crmDealsController.getDealsPipeline);
router.get('/crm-deals', protect, crmDealsController.getDealsPipeline);
router.get('/projects/workspace/:projectId', protect, projectWorkspaceController.getProjectWorkspace);
...
router.post('/staff', protect, userController.createStaffUser);
router.put('/staff/:id', protect, userController.updateStaffUser);
router.delete('/staff/:id', protect, userController.deleteStaffUser);
router.get('/users', protect, userController.listStaffUsers);
router.post('/users', protect, userController.createStaffUser);
router.put('/users/:id', protect, userController.updateStaffUser);
router.delete('/users/:id', protect, userController.deleteStaffUser);
...
router.get('/modules/hierarchy', protect, permissionController.getModuleHierarchy);
