...
const HIERARCHY: ParentDef[] = [
  ...
  { moduleName: 'CRM & Deals', moduleSlug: 'crm', children: [
    { moduleName: 'CRM Pipeline', moduleSlug: 'crm' },
    { moduleName: 'Deals Kanban', moduleSlug: 'deals' },
  ] },
  { moduleName: 'Point of Sale (POS)', moduleSlug: 'pos', children: [
    { moduleName: 'POS Terminal', moduleSlug: 'pos' },
  ] },
  { moduleName: 'Customer Support', moduleSlug: 'customer-support', children: [
    { moduleName: 'Helpdesk Tickets', moduleSlug: 'helpdesk' },
  ] },
  { moduleName: 'Projects Management', moduleSlug: 'projects-management', children: [
    { moduleName: 'Projects & Tasks', moduleSlug: 'projects' },
  ] },
  { moduleName: 'E-Documents & E-IMZO', moduleSlug: 'e-documents-signing', children: [
    { moduleName: 'E-Documents', moduleSlug: 'e-documents' },
  ] },
  ...
  { moduleName: 'Reports', moduleSlug: 'reports', children: [
    ...
    { moduleName: 'Soliq Reports', moduleSlug: 'soliq' },
  ] },
