...
async function seedAll(userId: string): Promise<void> {
  ...
  const employeeSpecs = [
    { id: 'demo-emp-1', firstName: 'Priya', lastName: 'Sharma', email: 'priya.sharma@demo.sapar.local' },
    { id: 'demo-emp-2', firstName: 'Arjun', lastName: 'Patel', email: 'arjun.patel@demo.sapar.local' },
    { id: 'demo-emp-3', firstName: 'Meera', lastName: 'Iyer', email: 'meera.iyer@demo.sapar.local' },
  ];
