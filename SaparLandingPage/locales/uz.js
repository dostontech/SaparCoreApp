export const uz = {
    ...
    pricing: {
        ...
        description: 'Barcha tariflarda 14 kunlik bepul sinov muddati mavjud. Hech qanday yashirin to‘lovlar yo‘q.',
        disclaimer: '* Barcha tariflar O‘zbekiston milliy valyutasi (UZS) da ko‘rsatilgan.',
        plans: [
            {
                name: 'Boshlang‘ich (Starter)',
                kicker: 'KICHIK DO‘KONLAR UCHUN',
                description: 'Chakana savdo va yangi boshlovchi bizneslar uchun',
                monthlyPrice: '290,000',
                yearlyPrice: '240,000',
                period: 'so‘m/oy',
                buttonText: '14 Kun Bepul Sinash',
                features: [
                    '1 ta Savdo nuqtasi & Ombor',
                    'POS Kassa & 58/80mm ESC/POS termal chek',
                    'Soliq OFD QR-kodi va MXIK kodlari',
                    'Telegram Boshqaruv Boti (@SaparBizOS_bot)',
                    '3 tagacha xodim hisobi',
                ],
            },
            {
                name: 'Biznes (Business)',
                kicker: 'ENG OMMABOP · TAVSIYA ETILADI',
                description: 'Ulgurji savdo, tarmoq do‘konlar va o‘rta korxonalar uchun',
                monthlyPrice: '690,000',
                yearlyPrice: '590,000',
                period: 'so‘m/oy',
                buttonText: '14 Kun Bepul Boshlash',
                features: [
                    'Cheksiz Omborlar & FIFO avtomat tannarx',
                    'Buxgalteriya 1/2-shakl & Oborotka',
                    'E-IMZO (USB) va E-Faktura Hub (Didox/Factura)',
                    'HRM Oylik maosh (12% QQS & Soliqlar) & Tabel',
                    'Kassir smena Z-hisobotlari & Kalkulyator',
                    '10 tagacha xodim hisobi',
                ],
            },
            {
                name: 'Korporativ (Enterprise)',
                kicker: 'ENTERPRISE',
                description: 'Yirik savdo tarmoqlari va ishlab chiqaruvchilar uchun',
                monthlyPrice: '1,490,000',
                yearlyPrice: '1,290,000',
                period: 'so‘m/oy',
                buttonText: 'Biz bilan bog‘laning',
                features: [
                    'Barcha 28 ta modul cheksiz',
                    'Bank API & 1C:ClientBank integratsiyasi',
                    'Shaxsiy hisob menejeri va 24/7 VIP qo‘llab-quvvatlash',
                    'Cheksiz xodimlar, filiallar va omborlar',
                    'Maxsus SLA kafolati',
                ],
            },
        ],
